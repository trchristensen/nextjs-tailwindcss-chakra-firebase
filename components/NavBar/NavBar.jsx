...
<div className="navBar md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
    <div className="flex-none w-56 flex flex-row items-center">
      <img src="/img/logo.png" className="w-10 flex-none" />
      <strong className="capitalize ml-1 flex-1">Barangay</strong>
